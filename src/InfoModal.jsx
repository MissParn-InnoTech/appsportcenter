...
// ป๊อปอัป Home / About / Contact สำหรับหน้า Login ของ ACT Sport Center
// ใช้: <InfoModal page={info} onClose={() => setInfo(null)} onChange={setInfo} />
//   page = "home" | "about" | "contact" | null (null = ปิด)
      ...
      >
        <div className="sticky top-0 flex items-center gap-1 border-b border-white/10 bg-[#1f1416]/95 px-3 py-2">
          ...
          <button onClick={onClose} aria-label="ปิด"
                  className="ml-auto rounded p-1.5 text-gray-400 hover:bg-white/10 hover:text-white">
            <X size={18} />
          </button>
        </div>
        <div className="p-6">
